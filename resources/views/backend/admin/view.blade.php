                                    ...
                                    <tbody>
                                      @foreach($items as $item)
                                        <tr>
                                            ...
                                            <td>{{$item->email}}</td>
                                            <td>{{$item->status}}</td>
                                            <td><a><i class="fas fa-user-check"></i>{{$item->status}}</a></td>
                                            <td><a id="edit-user" class="btn btn-outline sbold" data-toggle="modal" href="#large"
                                                    ><i class="far fa-edit"></i></a><a id="edit-user" onclick="return confirm('you are sure delete user?')" class="btn btn-outline sbold" data-toggle="modal" href="{{url('admin/admin/delete/'.$item->id)}}"
